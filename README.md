...
See the [/doc/usage/README.md usage](../blob/master/doc/usage/README.md) guide to set up Megadoc for your project.

## Hacking

See the [/doc/dev/README.md Developer's Handbook](../blob/master/doc/dev/README.md) for extending megadoc.
