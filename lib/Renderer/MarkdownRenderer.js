...
var HeaderTmpl = _.template(
  fs.readFileSync(path.resolve(__dirname, 'header.tmpl.html'), 'utf-8')
);

var RE_INTERNAL_LINK = Object.freeze(/^tiny:\/\//);
var RE_EXTERNAL_LINK = Object.freeze(/^https?:\/\//);

module.exports = function createRenderer(config) {
  ...
  renderer.link = function(href, title, text) {
    ...
    // props.href = decodeURIComponent(href.replace(RE_INTERNAL_LINK, ''));
