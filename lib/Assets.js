...
Assets.prototype.addRuntimePlugin = function(plugin) {
  pushUnique(this.runtimePlugins, plugin);
};

Assets.prototype.addInlinePluginScript = function(path) {
  pushUnique(this.inlineRuntimeScripts, path);
};

Assets.prototype.hasInlinePlugins = function() {
  return this.inlineRuntimeScripts.length > 0;
};
