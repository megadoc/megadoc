...
var RE_ESCAPED_LINK = Object.freeze(/[\\]\[([^\]]+)\]\(\)/g);
...
LinkResolver.prototype.linkify = function(docstring) {
  ...
  return String(docstring)
    ...
    //     [Module@prop]()
    //     [Module.staticMethod]()
    .replace(RE_TINY_LINK, function(original, path) {
