...
function LinkResolver(registry, corpus, options) {
  ...
  this.options.relativeAnchors = Boolean((options || {}).relativeAnchors);
...
LinkResolver.prototype.lookup = function(objectPath, params) {
  ...
  function Href(node, options) {
    ...
    if (options.relativeAnchors && params.contextNode && params.contextNode.meta.href) {
    ...
    return href + options.linkSuffix;
  }
