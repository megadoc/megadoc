...
module.exports = {
  ...
  layoutOptions: {
    /**
     * @property {Object.<uid: String, url: String>}
     *
     * Override the default URL for certain documents. You must use [UID UIDs]()
     ...
     * @property {Boolean}
     *
     * Launch tinydoc into "single-page" mode where you want to present all
     * the contents in a single page. This flag MUST be turned in order for
     * links to work online and offline.
     *
     * See the [guides/single-page-md Single Page guide]() for more information.
     */
